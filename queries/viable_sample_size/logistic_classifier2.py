    ...
    with tf.Session(graph=graph) as session:
      ...
      for step in range(num_steps):
        ...
        if (step == num_steps-1):
            ...
            output['loss'] = l
            output['train'] = accuracy(predictions, train_labels[:train_subset, :])
...
colors = ['b', 'c', 'y', 'm', 'r']
plt.title('Multinomial Logistic Classifier')
...
plt.legend((test,vali,trai),
           ...
           ncol=3,
           fontsize=8)
plt.savefig('/Users/nn31/Dropbox/40-githubRrepos/lungmap-scratch/queries/viable_sample_size/logistic_classifier2.png')
